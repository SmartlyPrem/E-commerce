...
const MainContext = (props) => {
    ...
    return (
        <Context.Provider value={{ openToast, userDetails, profileGet, fetchColor, stateToCart, products, CART_URL, PRODUCT_URL, USER_URL, categories, colors, COLOR_URL, categoryImageUrl, fetchCategoryData, CATEGORY_URL, fetchProducts, BASE_URL, ProdImgPath, ORDER_URL, formatPrice }}>
            <ToastContainer />
            {props.children}
        </Context.Provider>
    );
